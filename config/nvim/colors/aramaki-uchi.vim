...
let g:colors_name = "aramaki-uchi"

let s:gui_running = has('gui_running')

" Colors

noremap <leader><leader>1 i#c4cbcb<esc>
noremap <leader><leader>2 i#091217<esc>
noremap <leader><leader>3 i#648182<esc>

hi Cursor ctermfg=251 ctermbg=16 cterm=inverse guifg=#c4cbcb guibg=#648182 gui=inverse
hi Visual ctermfg=NONE ctermbg=59 cterm=NONE guifg=#c4cbcb guibg=#c4cbcb gui=NONE
...
hi LineNr ctermfg=66 ctermbg=145 cterm=NONE guifg=#091217 guibg=#648182 gui=NONE
hi CursorLineNr ctermfg=66 ctermbg=145 cterm=NONE guifg=#b22222 guibg=#091217  gui=bold,underline
...
hi StatusLine ctermfg=23 ctermbg=109 cterm=bold guifg=#c4cbcb guibg=#95a2a2 gui=bold
hi StatusLineNC ctermfg=23 ctermbg=109 cterm=NONE guifg=#c4cbcb guibg=#95a2a2 gui=NONE
...
hi Normal ctermfg=23 ctermbg=251 cterm=NONE guifg=#c4cbcb guibg=#091217 gui=NONE
...
hi DiffAdd ctermfg=23 ctermbg=113 cterm=bold guifg=#c4cbcb guibg=#96dd52 gui=bold
hi DiffDelete ctermfg=167 ctermbg=NONE cterm=NONE guifg=#e64949 guibg=NONE gui=NONE
hi DiffChange ctermfg=23 ctermbg=110 cterm=NONE guifg=#c4cbcb guibg=#9bb5cd gui=NONE
hi DiffText ctermfg=23 ctermbg=74 cterm=bold guifg=#c4cbcb guibg=#729fcf gui=bold
...
hi Float ctermfg=213 ctermbg=NONE cterm=NONE guifg=#b22222 guibg=schema.border gui=NONE
hi Function ctermfg=17 ctermbg=NONE cterm=bold guifg=#c4cbcb guibg=NONE gui=bold
hi Identifier ctermfg=30 ctermbg=NONE cterm=underline guifg=#297e87 guibg=NONE gui=underline,italic
hi Keyword ctermfg=60 ctermbg=NONE cterm=NONE guifg=#c4cbcb guibg=NONE gui=NONE
...
hi Number ctermfg=213 ctermbg=NONE cterm=NONE guifg=#b22222 guibg=schema.border gui=NONE
...
hi Special ctermfg=23 ctermbg=NONE cterm=NONE guifg=#c4cbcb guibg=NONE gui=NONE
...
hi Title ctermfg=23 ctermbg=NONE cterm=bold guifg=#c4cbcb guibg=NONE gui=bold
...
" hi rubyFunction ctermfg=17 ctermbg=NONE cterm=bold guifg=#c4cbcb guibg=NONE gui=bold
